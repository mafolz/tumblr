...
Gem::Specification.new do |s|
  s.name = %q{mafolz-tumblr-api}
  s.version = "0.1.6"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Jeff Kreeftmeijer", "Matthias Folz"]
  s.date = %q{2011-03-03}
  s.email = %q{folz.matthias@googlemail.com jeff@kreeftmeijer.nl}
  s.extra_rdoc_files = [
    "LICENSE",
    "README.rdoc"
  ]
  ...
  s.homepage = %q{http://github.com/mafolz/tumblr}
  s.require_paths = ["lib"]
